...
SWIFT_CLASS("_TtC7CoreSDK16CloudDataManager")
@interface CloudDataManager : NSObject
+ (CloudDataManager * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
@interface CloudDataManager (SWIFT_EXTENSION(CoreSDK)) <DataParserDelegate>
- (void)DataParserResult:(SenResultDataType)type valueDic:(NSMutableDictionary * _Null_unspecified)valueDic;
@end


SWIFT_CLASS("_TtC7CoreSDK10MqttClient")
...
@interface MqttClient (SWIFT_EXTENSION(CoreSDK)) <CocoaMQTTDelegate>
...
@interface MqttClient (SWIFT_EXTENSION(CoreSDK)) <CocoaMQTT5Delegate>
